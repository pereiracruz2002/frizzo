...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>static/css/dashboard.css" type="text/css" media="Screen" />
        <?php if (isset($css)): ?>
            <link rel="stylesheet" href="<?php echo base_url(); ?>static/css/<?php echo $css ?>" type="text/css" media="Screen" />
        <?php endif; ?> 

        <script type="text/javascript">var base_url = "<?php echo site_url(); ?>";</script>
        <script src="//code.jquery.com/jquery-1.11.0.min.js"></script>
        <?php if (isset($js)): ?>
            <script src="<?= base_url() ?>static/js/<?php echo $js; ?>" type="text/javascript"></script> 
        <?php endif; ?> 
    </head>
    <body>
